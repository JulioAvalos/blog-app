  ...
  return (
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      <h2 className='text-base text-stone-600 font-semibold tracking-wide uppercase'>
        Publicacion - Detalle de la publicacion completa y acceso a mantenimiento
      </h2>

      <div className="my-6 bg-white shadow-lg overflow-hidden sm:rounded-lg">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">Detalle de la publicacion</h3>
        <p className="mt-1 max-w-2xl text-sm text-gray-500">Hora, fecha y autor de la publicacion</p>
      </div>
