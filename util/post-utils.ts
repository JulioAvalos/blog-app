...
export const posts: IPost[] = [
  {
    ...
    slug: 'angular-cierra-para-siempre-en-2022',
    tags: ['programacion', 'tecnologia', 'angular'],
  },
  {
    _id: '2',
    ...
    slug: 'typescript-4.7-agregar-soporte-a-modulos-de-ecmascript-(ESM)',

    tags: ['programacion', 'tecnologia', 'nodejs'],
  },
  {
    _id: '3',
    title:
    ...
    slug: 'java-18-introduce-nuevas-caracteristicas-para-accelerar-su-desarrollo',

    tags: ['programacion', 'tecnologia', 'java'],
  },
  {
    _id: '4',
    ...
    slug: 'como-cambiar-de-color-de-la-fuente-usando-css',

    tags: ['programacion', 'tecnologia', 'css'],
  },
  {
    _id: '5',
    ...
    slug: 'fundador-de-docker-lanza-nueva-plataforma-devops',

    tags: ['programacion', 'tecnologia', 'docker'],
  },
  {
    _id: '6',
    ...
    slug: 'react-18-ahora-disponible-en-npm',

    tags: ['programacion', 'tecnologia', 'react'],
  },
  {
    _id: '7',
    ...
    slug: 'javascript-esta-en-todos-lados-incluso-en-msdos',
    tags: ['programacion', 'tecnologia', 'javascript'],
  },
];
